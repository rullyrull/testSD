        ...
        <div className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-2xl p-6 text-white shadow-lg">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div>
              ...
              <p className="opacity-90">Lihat dan kelola informasi pribadi kamu</p>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">Detail informasi pribadi kamu</p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">{currentUser?.nama || 'Budi Santoso'}</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">{currentUser?.nis || '12345'}</p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium">Agus Santoso</p>
                </div>
              </div>
      ...
      >
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">Ganti password akun kamu secara berkala untuk keamanan</p>
          </div>
